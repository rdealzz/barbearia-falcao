  ...
  return (
    <div className="space-y-8">
      <header className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <h1 className="font-display text-3xl text-content">Agendamentos</h1>
      ...
      <nav className="flex gap-2 border-b border-line" aria-label="Filtro de agendamentos">
        {[
          ...
          <Link
            ...
            className={`-mb-px border-b-2 px-4 py-3 text-sm transition-colors ${
              tab === item.key
                ? 'border-falcao-500 text-content'
